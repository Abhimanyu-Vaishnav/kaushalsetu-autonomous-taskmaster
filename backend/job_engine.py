...
JOB_CATALOG: List[Dict[str, Any]] = [
    ...
    },
    {
        ...
        "source_platform": "Naukri Grounded",
        "experience_required": "0-2 Years",
    ...
    },
    {
        ...
        "source_platform": "Indeed Grounded",
        "experience_required": "0-2 Years",
    ...
    },
    {
        "job_id": "JOB-9013",
        "category": "Healthcare Assistant",
        "role_title": "Patient Care & Diagnostic Lab Technician",
        "company_name": "Apollo Hospitals Group",
        "location": "Gurugram / Delhi NCR",
        "ctc_range": "₹3.6L - ₹5.2L PA",
        "source_platform": "Naukri Grounded",
        "experience_required": "0-2 Years",
        "job_description": "Execute phlebotomy blood draws, maintain blood sample barcode logs, calibrate centrifuge equipment, and assist outpatient diagnostic procedures.",
        "recruiter_email": "careers@apollohospitals.com",
        "skills_matched": ["Phlebotomy", "Lab Diagnostics", "Sample Handling", "Patient Care"],
        "match_percentage": 87,
        "apply_url": "https://careers.apollohospitals.com/lab-tech"
    },
    ...
    },
    {
        "job_id": "JOB-9015",
        "category": "Solar Installation & Green Energy",
        "role_title": "Renewable Energy Maintenance Technician",
        "company_name": "ReNew Power Green Tech",
        "location": "Gurugram / Neemrana",
        "ctc_range": "₹4.2L - ₹6.2L PA",
        "source_platform": "LinkedIn Jobs",
        "experience_required": "0-2 Years",
        "job_description": "Execute preventive maintenance on commercial solar farms, replace faulty combiner box diodes, measure panel irradiance efficiency, and maintain grid uptime.",
        "recruiter_email": "careers@renewpower.in",
        "skills_matched": ["Solar Maintenance", "Combiner Boxes", "Diode Inspection", "Electrical Wiring"],
        "match_percentage": 89,
        "apply_url": "https://renewpower.in/careers/solar-maintenance"
    },
    ...
    # --- DIGITAL MARKETING & CONTENT ---
    {
        ...
        "role_title": "Performance Marketing & SEO Specialist",
        "company_name": "Nykaa E-Commerce Digital",
        "location": "Gurugram / Hybrid",
        "ctc_range": "₹4.2L - ₹6.0L PA",
        "source_platform": "LinkedIn Jobs",
        "experience_required": "0-2 Years",
        "job_description": "Manage Google Ads search campaigns, optimize web keyword rankings using Ahrefs/Semrush, analyze Google Analytics 4 traffic metrics, and boost ROAS.",
        "recruiter_email": "digital.hiring@nykaa.com",
        "skills_matched": ["SEO", "Google Ads", "Google Analytics", "Keyword Research"],
        "match_percentage": 88,
        "apply_url": "https://nykaa.com/careers/seo-specialist"
    },
...
def search_live_jobs(
    ...
    """
    Multi-source Grounded Live Job Matching Engine.
    Filters catalog based on course track, search text, location, and minimum skill alignment.
    """
    ...
    for job in JOB_CATALOG:
        ...
        # 1. Course Track Alignment Check
        course_align = True
        if clean_course:
            # Check if any key term from course matches category or title
    ...
    # Fallback to full catalog if query was too strict
    if not results and (clean_course or clean_query):
        for job in JOB_CATALOG:
            if clean_query in job.get("role_title", "").lower() or clean_query in job.get("company_name", "").lower():
                results.append(job)
