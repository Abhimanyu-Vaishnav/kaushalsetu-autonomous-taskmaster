# 3:45 DEMO SCRIPT & SCREENPLAY: KAUSHALSETU AUTONOMOUS TASKMASTER
...
| :--- | :--- | :--- |
| **0:00 - 0:35** | **Title Slide & Google Cloud Run Deployed URL**<br>Show live Cloud Run service running on `https://kaushalsetu-taskmaster-uc.a.run.app` & local `http://localhost:8501`. | "Welcome to **KaushalSetu: Autonomous Vocational Taskmaster**, built for the Google All Things Agentic Hackathon under the **Taskmaster Track**. Vocational foundations across India face a 4.5-hour administrative bottleneck per candidate: manually drafting exams, grading circuits, and searching job portals. KaushalSetu is a 100% Zero-Human-in-the-Loop continuous action engine that executes this entire lifecycle in just **3.2 seconds**." |
